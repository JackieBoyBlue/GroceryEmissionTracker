...
if __name__ == '__main__':
    ...
    SenT5 = SentenceT5()
    embeddings = SenT5.get_embeddings(item_1, category_1, category_2, category_3, category_4, category_5, category_6, category_7, category_8, category_9, category_10, category_11, category_12)
    print(embeddings)
